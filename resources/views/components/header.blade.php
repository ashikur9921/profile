...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="{{asset('allitem/assets/favicon.ico') }}" />
        <!-- Custom Google font-->
        ...
        <link href="{{asset('allitem/css/styles.css') }}" rel="stylesheet" />
    </head>
        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="{{ route('home') }}"><span class="fw-bolder text-primary">Ashiqur Rahman</span></a>
